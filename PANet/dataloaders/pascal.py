...
class VOC(BaseDataset):
    ...
    def __init__(self, base_dir, split, transforms=None, to_tensor=None):
        ...
        dir_trainaug = "/content/drive/MyDrive/Colab Notebooks/Kursinis/PANet/data/Pascal/VOCdevkit/ImageSets/Segmentation/trainaug.txt"
        with open(dir_trainaug, 'r') as f:
